...
class Gallery extends CI_Controller {
	...
	public function listGallery() {
		...
		$data = array(
            ...
            'page_title' 		=> 'Todas as imagens da galeria',
	...
	public function addImg(){
		...
		$data = array(
            'page_data'     => $this->page_data,
            'page_title'    => 'Adicionar imagem da galeria',
            'user'          => $this->admin_user,
	...
	public function editImg($id = null) {
        ...
        if($gallery = $this->GalleryModel->getGallery($id)) {
            $data = array(
                'page_data'     	=> $this->page_data,
                'page_title'    	=> 'Editando: ' . html_entity_decode($gallery['imgName']),
                'user'          	=> $this->admin_user,
				'gallery'      		=> $gallery,
				'listGalleryWidCat'	=> $this->listGalleryWidCat,
				'categories' 		=> $this->all_cats
	...
	public function catEdit($id = null){
		if($categories = $this->GalleryModel->getCat($id)) {
            $data = array(
                'page_data'     => $this->page_data,
                'page_title'    => 'Editando: ' . html_entity_decode($categories['cName']),
                'user'          => $this->admin_user,
