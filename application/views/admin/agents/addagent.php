        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-home">
                        <a href="<?php anchor_to(AGENTS_CONTROLLER) ?>">Todos os Profissionais</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="agentName">Nome <span class="text-danger">*</span></label>
                                    <?php echo form_error('agentName', '<br><span class="text-danger">', '</span>'); ?>
                                    <input class="form-control" type="text" id="agentName" name="agentName" placeholder="Nome" value="<?php echo set_value('agentName')?>">
                                </div>
                                <div class="form-group">
                                    <label for="agentDescription">Descrição <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="experience">Experiência (Anos) <span class="text-danger">*</span></label>
                                                    <?php echo form_error('experience', '<br><span class="text-danger">', '</span>'); ?>
                                                    <input value="1" min="1" step="1" class="form-control" type="number" id="service-price" name="experience" placeholder="Experiência" value="<?php echo set_value('experience')?>">
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="totalBookings">Total Agendamentos <span class="text-danger">*</span></label>
                                                    <?php echo form_error('totalBookings', '<br><span class="text-danger">', '</span>'); ?>
                                                    <input value="1"  min="1" step="1" class="form-control" type="number" id="totalBookings" name="totalBookings" placeholder="Total Agendamentos" value="<?php echo set_value('totalBookings')?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="site-logo">Selecionar imagem do profisssional <span class="text-danger">*</span></label>
                            ...
                            <div class="card-footer">
                                <div class="form-group text-right">
                                    ...
                                    <a href="<?php anchor_to(AGENTS_CONTROLLER . '/services'); ?>" class="btn btn-danger text-white mr-4"><i class="fas fa-arrow-left mr-1"></i> Voltar</a>
