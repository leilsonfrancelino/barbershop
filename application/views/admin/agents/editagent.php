                        ...
                        <div class="card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input min="1" step="1" class="form-control" type="number" id="service-price" name="experience" placeholder="Experiência" value="<?php echo esc(set_value('experience', $agent['experience']), true)?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input min="1" step="1" class="form-control" type="number" id="totalBookings" name="totalBookings" placeholder="Total Agendamentos" value="<?php echo esc(set_value('totalBookings', $agent['totalBookings']), true)?>">
                                                </div>
                                            </div>
                            ...
                            <div class="card-footer">
                                <div class="form-group text-right">
                                    ...
                                    <a href="<?php anchor_to(AGENTS_CONTROLLER); ?>" class="btn btn-danger text-white mr-4"><i class="fas fa-arrow-left mr-1"></i> Voltar</a>
                                    <button class="btn btn-success"><i class="fas fa-save mr-1"></i> Criar Página</button>
                                </div>
                            </div>
                        </div>
                    </form>
