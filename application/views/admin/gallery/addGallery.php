                    ...
                    <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="image-title">Título da Imagem <span class="text-danger">*</span></label>
                                    <?php echo form_error('image-title', '<br><span class="text-danger">', '</span>'); ?>
                                    <input class="form-control" type="text" id="image-title" name="image-title" placeholder="Escolha o título da imagem" value="<?php echo esc(set_value('image-title'), true)?>">
                                </div>
                                <div class="form-group">
                                    <label for="image-content">Pequena descrição da imagem <span class="text-danger">*</span></label>
                                    <?php echo form_error('image-content', '<br><span class="text-danger">', '</span>'); ?>
                                    <textarea id="service-content" name="image-content" class="form-control" placeholder="Escolha o título da imagem"><?php echo esc(set_value('image-content'), true)?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="categoryId">Categoria da imagem <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="gImage">Selecione a imagem da galeria <span class="text-danger">*</span></label>
                            ...
                            <div class="card-footer">
                                <div class="form-group text-right">
                                    ...
                                    <a href="<?php anchor_to(GALLERY_CONTROLLER); ?>" class="btn btn-danger text-white mr-4"><i class="fas fa-arrow-left mr-1"></i> Voltar</a>
                                    <button class="btn btn-success"><i class="fas fa-save mr-1"></i> Adicionar Imagem</button>
                                </div>
                            </div>
                        </div>
                    </form>
