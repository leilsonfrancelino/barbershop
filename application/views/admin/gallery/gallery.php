                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?php anchor_to(GALLERY_CONTROLLER . '/addImg') ?>" class="btn btn-primary float-right"><i class="fas fa-plus mr-2"></i> Adicionar Imagem</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        <?php if(!$listGalleryWidCat){?>
                                            <tr>
                                                <td colspan="6" class="text-center"><h4 class="text-muted">Nenhuma Imagem Encontrada.</h4></td>
                                            </tr>
                                        <?php } else{?>
                                        <?php $i = 1; foreach ($listGalleryWidCat as $listGall){ ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="<?php anchor_to(GALLERY_CONTROLLER . '/editImg/' . $listGall['id']) ?>" data-toggle="tooltip" data-placement="top" title="Editar" class="btn btn-link btn-primary btn-lg">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-link btn-danger deleteImg" data-toggle="tooltip" data-placement="top" title="Excluir" value="<?php echo esc($listGall['id'], true) ?>"><i class="fa fa-times"></i></button>
                                                </td>
                                            </tr>
                                        <?php $i++; } }?>
                                    </tbody>
