            ...
            <div class="col-md-12">
               <div class="card">
                  <div class="card-header">
                     <div class="card-title">Atualize suas Configurações Gerais</div>
                  </div>
				  <form enctype="multipart/form-data" action="<?php anchor_to(GENERAL_CONTROLLER . '/settings') ?>" method="POST">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									<label for="site-title">Título</label>
									...
									<small>Isso será usado como o título em todo o aplicativo..</small>
								</div>
								<div class="form-group">
									...
									<small>Isso será incluído automaticamente na tag <code>&lt;head&gt;</code> como Meta Description.</small>
								</div>
								<div class="form-group">
									<label for="site-keywords">Palavras-chave</label>
					...
					<div class="card-action">
						...
						<button type="submit" class="btn btn-success"><i class="fas fa-check mr-1"></i> Atualizar Configurações</button>
					</div>
				  </form>
               </div>
            </div>
