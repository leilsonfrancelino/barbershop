				...
				<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
					<?php if($user['disabled']) { ?>
						<li class="nav-item dropdown hidden-caret">
							<a class="btn btn-danger text-white">
								Algumas configurações são desativadas no modo de demonstração.
							</a>
						</li>
					<?php } ?>
                    <li class="nav-item dropdown hidden-caret">
                        <a target="_blank" class="btn btn-primary pb-1 pt-1 pl-3 pr-3" href="<?php anchor_to() ?>"><i class="fas fa-external-link-alt mr-1"></i> Visitar Website</a>
					</li>
										...
										<div class="notif-center">
											<a href="https://codecanyon.net/item/salon-booking-management-system/28185575" terget="_blank">
												...
												<div class="notif-content">
													...
													<span class="time">Sua versão atual está desatualizada.</span> 
												</div>
											</a>
										</div>
									</div>
					...
					<?php } else { ?>
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
								<li>
									<div class="dropdown-title">Você tem 0 notificação.</div>
								</li>
								<li>
									<div class="dropdown-title font-weight-light">Você não tem novas notificações.</div>
								</li>
							</ul>
						</li>
					<?php } ?>
                    <li class="nav-item dropdown hidden-caret">
						...
						<ul class="dropdown-menu dropdown-user animated fadeIn">
							<div class="dropdown-user-scroll scrollbar-outer">
								...
								<li>
									<a class="dropdown-item" href="<?php anchor_to(ACCOUNT_CONTROLLER . '/me') ?>">Configurar conta</a>
									<a class="dropdown-item" href="<?php anchor_to(AUTH_CONTROLLER . '/logout') ?>">Sair</a>
								</li>
							</div>
						</ul>
					</li>
