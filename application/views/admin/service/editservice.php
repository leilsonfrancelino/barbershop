                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="service-title" name="service-title" placeholder="Escolha o título do serviço" value="<?php echo esc(set_value('service-title', $service['title']), true)?>">
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input data-decimals="2" min="1" step="0.1" class="form-control" type="number" id="service-price" name="service-price" placeholder="Escolha o preço do serviço" value="<?php echo esc(set_value('service-price', $service['price']), true)?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input min="1" step="1" class="form-control" type="number" id="service-space" name="service-space" placeholder="Escolha o espaço de serviço" value="<?php echo esc(set_value('service-space', $service['servSpace']), true)?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="servStarts" type="text" name="service-starts" placeholder="Tipo: 08:00 PM" value="<?php echo set_value('service-starts', $service['servStart'])?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="servEnds" type="text" name="service-ends" placeholder="Tipo: 05:00 PM" value="<?php echo esc(set_value('service-ends', $service['servEnd']), true)?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" id="service-duration" name="service-duration" placeholder="Duração do serviço: 02:30" value="<?php echo esc(set_value('service-duration', $service['servDuration']), true)?>">
                                                </div>
                                            </div>
											<div class="col-12">
                                                <div class="form-group">
                            ...
                            <div class="card-footer">
                                <div class="form-group text-right">
                                    ...
                                    <a href="<?php anchor_to(SERVICE_CONTROLLER); ?>" class="btn btn-danger text-white mr-4"><i class="fas fa-arrow-left mr-1"></i> Voltar</a>
                                    <button class="btn btn-success"><i class="fas fa-save mr-1"></i> Salvar Alterações</button>
                                </div>
                            </div>
                        </div>
                    </form>
