                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php anchor_to(SERVICE_CONTROLLER . '/addservice') ?>" class="btn btn-primary float-right"><i class="fas fa-plus mr-2"></i> Adicionar Serviço</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody>
                                        <?php if(!$agent_List_By_Service){?>
                                            <tr>
                                                <td colspan="6" class="text-center"><h4 class="text-muted">Nenhum Serviço Encontrado.</h4></td>
                                            </tr>
                                        <?php } else{?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php anchor_to(SERVICE_CONTROLLER . '/editservice/' . $serv['id']) ?>" data-toggle="tooltip" data-placement="top" title="Editar" class="btn btn-link btn-primary btn-lg">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <button type="button" class="btn btn-link btn-danger deleteService" data-toggle="tooltip" data-placement="top" title="Excluir" value="<?php echo esc($serv['id'], true) ?>"><i class="fa fa-times"></i></button>
                                            </td>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
